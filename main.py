...
def chiffrerFich(nom_fich: str, cle: str) -> list:
    ...
    try:
        ...
        # écriture
        # CORRECTION ICI : 'wt' au lieu de 1
        with open(chemin_complet, 'wt', encoding='utf-8') as fread:
...
choix_cle = input("Votre choix (1 ou 2) : ")
        ...
        if cle:
            ...
            if save.lower() == 'o':
                try:
                    ...
                    chemin_cle = os.path.join(dossier_script, "cle.txt")
